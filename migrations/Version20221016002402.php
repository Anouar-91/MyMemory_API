 ...
 */
final class Version20221016002402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fr_word_en_word (fr_word_id INT NOT NULL, en_word_id INT NOT NULL, INDEX IDX_CDA196C7131B8A8B (fr_word_id), INDEX IDX_CDA196C7B2D880ED (en_word_id), PRIMARY KEY(fr_word_id, en_word_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
